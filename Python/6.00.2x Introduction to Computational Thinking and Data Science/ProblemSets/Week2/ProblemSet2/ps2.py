...
class RectangularRoom(object):
    ...
    def __init__(self, width, height):
        ...
        self.width = width
        self.height = height
        self.room = [[False for x in range(height)] for x in range(width)] 
    ...
    def isPositionInRoom(self, pos):
        ...
        """
        return self.width > pos.getX() and self.height > pos.getY() and pos.getX() >= 0 and pos.getY() >= 0
...
class StandardRobot(Robot):
    ...
    def updatePositionAndClean(self):
        ...
        nextPosition = currentPosition.getNewPosition(self.direction, self.speed)

        inRoom = self.room.isPositionInRoom(nextPosition)
